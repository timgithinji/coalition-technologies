			...
			<form action="{{action('HomeController@postProducts')}}" method="POST"   id="interview_form" enctype="multipart/form-data">
				...
				<div class="email">
					<span class="input input--nao">
						<input class="input__field input__field--nao" type="text" id="input-3" name="product_name" value=""  required />
				...
				<div class="email">
					<span class="input input--nao">
						<input class="input__field input__field--nao" type="text" id="input-3" name="stock_quantity" value=""  required />
						<label class="input__label input__label--nao" for="input-3">
				...
				<div class="email">
					<span class="input input--nao">
						<input class="input__field input__field--nao" type="text" id="input-3" name="price" value=""  required />
						<label class="input__label input__label--nao" for="input-3">
